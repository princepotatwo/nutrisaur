...
(9, 82, 'new_event', 'barangay', 'A. Rivera (Pob.)', 0, 0, 'No FCM tokens found for location', '2025-08-18 12:54:33'),
(10, 83, 'new_event', 'barangay', 'A. Rivera (Pob.)', 1, 0, NULL, '2025-08-18 12:58:40'),
(11, 84, 'new_event', 'barangay', 'A. Rivera (Pob.)', 0, 0, 'No FCM tokens found for location', '2025-08-18 13:03:23'),
...
(16, 89, 'new_event', 'barangay', 'A. Rivera (Pob.)', 1, 1, NULL, '2025-08-18 16:20:39'),
(17, 90, 'new_event', 'barangay', 'A. Rivera (Pob.)', 0, 0, 'No FCM tokens found for location', '2025-08-18 17:52:25'),
(18, 91, 'imported_event', 'barangay', 'Sample Location', 0, 0, 'No FCM tokens found for location', '2025-08-18 18:58:30'),
(19, 92, 'imported_event', 'barangay', 'Sample Location', 0, 0, 'No FCM tokens found for location', '2025-08-18 19:15:02'),
(20, 93, 'imported_event', 'barangay', 'Sample Location', 0, 0, 'No FCM tokens found for location', '2025-08-18 19:15:56'),
(21, 94, 'new_event', 'barangay', 'Lamao', 0, 0, 'No FCM tokens found for location', '2025-08-18 19:16:14'),
(22, 95, 'new_event', 'barangay', 'MUNICIPALITY_BAGAC', 0, 0, 'No FCM tokens found for location', '2025-08-18 19:16:54'),
(23, 96, 'new_event', 'barangay', 'MUNICIPALITY_ABUCAY', 0, 0, 'No FCM tokens found for location', '2025-08-18 19:17:28'),
(24, 98, 'new_event', 'all', 'all', 0, 0, 'No FCM tokens found for location', '2025-08-18 21:22:50'),
(25, 99, 'new_event', 'all', 'all', 0, 0, 'No FCM tokens found for location', '2025-08-18 21:23:09'),
(26, 100, 'new_event', 'barangay', 'A. Rivera (Pob.)', 1, 1, NULL, '2025-08-18 22:15:11'),
...
(335, 'sKevin', 'kevinpingol123@gmail.com', '$2y$10$4q97cGTt8OyhHilWTLgHreVPZPAkm.i3k6VC590rY/X3uRtiikNUK', '2025-08-20 03:35:38', '2025-08-20 03:40:40', 1);
...
--
ALTER TABLE `user_notifications`
  ADD CONSTRAINT `fk_user_notifications_email` (`user_email`) REFERENCES `users` (`email`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
