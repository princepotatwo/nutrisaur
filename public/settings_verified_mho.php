<?php
// VERIFIED MHO Version - Complete malnutrition assessment with official WHO standards
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Settings - VERIFIED MHO Version</title>
    <style>
        ...
        .verification-badge { background: #28a745; color: white; padding: 5px 10px; border-radius: 15px; font-size: 12px; font-weight: bold; }
    </style>
</head>
<body>
    <div class="container">
        <div class="header">
            <h1>Settings - VERIFIED MHO Version <span class="verification-badge">✅ VERIFIED</span></h1>
            <div>
        ...
        <div class="mho-section">
            <div class="mho-title">🌱 MHO (Malnutrition and Hunger Observatory) Standards - VERIFIED ✅</div>
            <p><strong>This system uses OFFICIAL MHO-approved calculations for malnutrition risk assessment based on WHO standards for different age groups.</strong></p>
            <ul>
                <li>✅ Children 6-59 months: MUAC thresholds (MHO Standard)</li>
                <li>✅ Children 5-19 years: BMI-for-age (WHO MHO Standard)</li>
                <li>✅ Adults 20+: BMI thresholds (WHO MHO Standard)</li>
                <li>✅ Additional risk factors: allergies, diet preferences</li>
                <li>✅ Risk scoring: 0-100 scale (MHO Standard)</li>
            </ul>
        </div>
    ...
    <script>
        // VERIFIED MHO FUNCTIONS - All functions accessible to onclick handlers
        ...
        // ✅ VERIFIED MHO RISK SCORE CALCULATION FUNCTION
        ...
        function loadUsers() {
            ...
            fetch('../unified_api.php?type=usm')
                ...
                .then(data => {
                    ...
                    showAlert('success', `Loaded ${data.users.length} users with VERIFIED MHO risk assessments`);
                })
                .catch(error => {
        ...
        function updateMHORiskScores() {
            if (confirm('Update all risk scores using VERIFIED MHO calculations?')) {
        ...
        function exportUsers() {
            ...
            // Create CSV content with VERIFIED MHO data
            ...
            a.href = url;
            a.download = 'users_with_verified_mho_data.csv';
            document.body.appendChild(a);
            a.click();
            document.body.removeChild(a);
            window.URL.revokeObjectURL(url);
            
            showAlert('success', '✅ Users exported to CSV with VERIFIED MHO risk data');
        }
        ...
        document.addEventListener('DOMContentLoaded', function() {
            console.log('✅ VERIFIED MHO Page loaded, functions available:', {
