<?php
// Simple data viewer that works with Railway routing
header('Content-Type: text/html; charset=UTF-8');

// Get data using DatabaseAPI
$apiUrl = 'https://nutrisaur-production.up.railway.app/api/DatabaseAPI.php?action=select';
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="controls">
                <a href="/view_data.php" class="btn btn-primary">🔄 Refresh Data</a>
