<?php
// get_refresh_token.php - Run this once to get your refresh token
...
$redirectUri = 'https://nutrisaur-production.up.railway.app/get_refresh_token.php';
...
if (!isset($_GET['code'])) {
    ...
    echo "<p>Click the link below to authorize your Gmail account:</p>";
...
if (isset($tokens['refresh_token'])) {
    ...
    echo "<li>Delete this file (get_refresh_token.php) for security</li>";
    echo "</ol>";
} else {
    echo "<h2>❌ Error</h2>";
