...
.light-theme .navbar-minimized-icons {
    background: linear-gradient(135deg, rgba(142, 185, 110, 0.1) 0%, rgba(142, 185, 110, 0.05) 100%);
    border-right-color: rgba(142, 185, 110, 0.2);
}

.light-theme .minimized-icon {
    background: rgba(142, 185, 110, 0.1);
    border-color: rgba(142, 185, 110, 0.2);
    color: var(--color-text);
}

.light-theme .minimized-icon:hover {
    background: rgba(142, 185, 110, 0.2);
    border-color: rgba(142, 185, 110, 0.4);
    box-shadow: 0 2px 8px rgba(142, 185, 110, 0.2);
}
...
<body class="light-theme">
    ...
    <div class="navbar" id="navbar">
        <!-- Minimized Icons Display -->
        <div class="navbar-minimized-icons" id="navbar-minimized-icons">
            <div class="minimized-icon" title="Dashboard">
            ...
            <div class="minimized-icon" title="MHO Assessment">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <div class="minimized-icon" title="Nutrition Event Notifications">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    <path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"></path>
                    <path d="M13.73 21a2 2 0 0 1-3.46 0"></path>
                </svg>
            </div>
            <div class="minimized-icon" title="Settings & Admin">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    <circle cx="12" cy="12" r="3"></circle>
                    <path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83 2 2 0 0 1-2.83 0l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83 0 2 2 0 0 1 0-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1-2-2 2 2 0 0 1 2-2h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 0-2.83 2 2 0 0 1 2.83 0l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1 1.51V3a2 2 0 0 1 2-2 2 2 0 0 1 2 2v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 0 2 2 0 0 1 0 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 2 2 2 2 0 0 1-2 2h-.09a1.65 1.65 0 0 0-1.51 1z"></path>
                </svg>
            </div>
            <div class="minimized-icon" title="Logout">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    <path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path>
                    <polyline points="16,17 21,12 16,7"></polyline>
                    <line x1="21" y1="12" x2="9" y2="12"></line>
    ...
    <script>
        ...
        function initNavigation() {
            ...
            // Initialize minimized icons functionality
            initMinimizedIcons();
        ...
        // Initialize minimized icons functionality
        function initMinimizedIcons() {
            console.log('🔍 Initializing minimized icons...');
            
            const minimizedIcons = document.getElementById('navbar-minimized-icons');
            const iconElements = document.querySelectorAll('.minimized-icon');
            
            console.log('🔍 Minimized icons container:', !!minimizedIcons);
            console.log('🔍 Icon elements found:', iconElements.length);
            
            if (minimizedIcons && iconElements.length > 0) {
                // Add click handlers to each minimized icon
                iconElements.forEach((icon, index) => {
                    icon.addEventListener('click', function() {
                        ...
                        if (links[index]) {
                            console.log('🔍 Minimized icon clicked, navigating to:', links[index]);
                            window.location.href = links[index];
                        }
                    });
                });
                
                console.log('✅ Minimized icons initialized successfully');
            } else {
                console.log('⚠️ Minimized icons not found or not properly initialized');
            }
        }
