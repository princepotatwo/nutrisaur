...
/* Navbar Icon Styles - Position on far right when minimized */
.navbar-icon {
    margin-right: 15px;
    width: 24px;
    font-size: 20px;
...
<body class="light-theme">
    ...
    <div class="navbar" id="navbar">
        ...
        <div class="navbar-menu">
            <ul>
                <li><a href="dash"><span class="navbar-icon"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="7" height="7"></rect><rect x="14" y="3" width="7" height="7"></rect><rect x="14" y="14" width="7" height="7"></rect><rect x="3" y="14" width="7" height="7"></rect></svg></span><span>Dashboard</span></a></li>
                <li><a href="screening"><span class="navbar-icon"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 11H5a2 2 0 0 0-2 2v7a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7a2 2 0 0 0-2-2h-4"></path><polyline points="9,11 9,7 15,7 15,11"></polyline><path d="M9 7V3a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v4"></path></svg></span><span>MHO Assessment</span></a></li>
                <li><a href="event"><span class="navbar-icon"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"></path><path d="M13.73 21a2 2 0 0 1-3.46 0"></path></svg></span><span>Nutrition Event Notifications</span></a></li>
                <li><a href="settings"><span class="navbar-icon"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="3"></circle><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83 2 2 0 0 1-2.83 0l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83 0 2 2 0 0 1 0-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1-2-2 2 2 0 0 1 2-2h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 0-2.83 2 2 0 0 1 2.83 0l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1 1.51V3a2 2 0 0 1 2-2 2 2 0 0 1 2 2v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 0 2 2 0 0 1 0 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 2 2 2 2 0 0 1-2 2h-.09a1.65 1.65 0 0 0-1.51 1z"></path></svg></span><span>Settings & Admin</span></a></li>
                <li><a href="logout" style="color: #ff5252;"><span class="navbar-icon"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path><polyline points="16,17 21,12 16,7"></polyline><line x1="21" y1="12" x2="9" y2="12"></line></svg></span><span>Logout</span></a></li>
            </ul>
        </div>
        ...
        <div class="filter-section">
            <div class="filter-container">
                ...
                <div class="filter-group">
                    ...
                    <div class="custom-select-container small-width">
                        <div class="select-header disabled" id="barangay-select-header" onclick="toggleDropdown()">
                            <span id="selected-option">Select Barangay</span>
                            <span class="dropdown-arrow">▼</span>
                        </div>
                    <div class="dropdown-content" id="dropdown-content">
                        <div class="options-container">
                            <!-- Barangays will be dynamically populated when municipality is selected -->
                            <div class="option-item disabled" style="opacity: 0.5; cursor: not-allowed;">
    ...
    <script>
        ...
        function updateBarangayDropdown(municipality) {
            ...
            try {
                ...
                const barangaySelectHeader = document.getElementById('barangay-select-header');
                ...
                // Enable the barangay dropdown (remove disabled class)
                if (barangaySelectHeader) {
                    barangaySelectHeader.classList.remove('disabled');
                    console.log('✅ Barangay dropdown enabled');
                }
        ...
        // Toggle dropdown function (parametrized version - currently unused)
