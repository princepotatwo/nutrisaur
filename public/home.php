    ...
    <div class="container">
        ...
        <div class="login-box">
            ...
            <form id="auth-form" method="post" action="" autocomplete="off" style="display: none;">
                ...
                <a href="forgot_password.php" class="toggle-link" id="forgot-password-link" style="margin-top: 0; margin-bottom: 2px; display: block; text-align: right;">Forgot Password?</a>
