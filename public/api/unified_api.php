...
// REMOVED DUPLICATE handleSaveScreening function - keeping only the working one from localapi.php

// Handle getting screening data for mobile app
// REMOVED DUPLICATE handleGetScreeningData function - keeping only the working one from localapi.php
