<?php
// Simple data viewer using DatabaseAPI
header('Content-Type: text/html; charset=UTF-8');

// Get data using DatabaseAPI
$apiUrl = '/api/DatabaseAPI.php?action=select';
$postData = json_encode(['table' => 'community_users', 'order_by' => 'screening_date DESC']);

$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, 'https://nutrisaur-production.up.railway.app' . $apiUrl);
...
if ($data && $data['success']) {
    ...
    $error = 'Failed to load data: ' . ($data['message'] ?? 'Unknown error');
    $users = [];
    $totalUsers = 0;
    $municipalities = [];
    $maleUsers = 0;
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="controls">
                <a href="/api/data_viewer.php" class="btn btn-primary">🔄 Refresh Data</a>
