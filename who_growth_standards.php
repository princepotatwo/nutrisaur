...
class WHOGrowthStandards {
    ...
    public function getWeightForAgeBoysLookupTable() {
        return [
            ...
            // Age 8 months
            8 => [
                'severely_underweight' => ['min' => 0, 'max' => 4.8],
                'underweight' => ['min' => 4.9, 'max' => 5.3],
                'normal' => ['min' => 5.4, 'max' => 8.2],
                'overweight' => ['min' => 8.3, 'max' => 999]
            ],
            // Age 9 months
            9 => [
                'severely_underweight' => ['min' => 0, 'max' => 5.0],
                'underweight' => ['min' => 5.1, 'max' => 5.5],
                'normal' => ['min' => 5.6, 'max' => 8.5],
                'overweight' => ['min' => 8.6, 'max' => 999]
            ],
            // Age 10 months
            10 => [
