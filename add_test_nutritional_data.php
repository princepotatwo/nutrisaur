<?php
// Script to add diverse nutritional assessment test data
...
try {
    ...
    echo "Successfully added " . count($testData) . " diverse test records!\n";
    echo "Now the screening page should show various nutritional statuses:\n";
    echo "- Severe Acute Malnutrition (SAM)\n";
    echo "- Moderate Acute Malnutrition (MAM)\n";
    echo "- Maternal Undernutrition (At-risk)\n";
    echo "- Severe Underweight\n";
    echo "- Moderate Underweight\n";
    echo "- Mild Underweight\n";
    echo "- Normal\n";
    echo "- Overweight\n";
    echo "- Obesity Class I\n";
    echo "- Obesity Class II\n";
    echo "- Obesity Class III (Severe)\n";
